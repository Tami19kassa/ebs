...
// We add 'as any' to silence TypeScript errors completely
...
export const UniversalPlayer = ({ url, poster }: { url: string; poster: string }) => {
  return (
    <div className="relative w-full aspect-video bg-gray-900 rounded-xl overflow-hidden border border-white/10 shadow-2xl group">
      ...
      {/* Fallback pattern if poster is missing */}
      ...
      <ReactPlayer
        ...
        height="100%"
        controls={true}
        // FIX 1: Only use 'light' mode if a poster actually exists. 
        // Otherwise, let YouTube show its own thumbnail.
        light={poster ? poster : false} 
        
        // FIX 2: Disable autoplay. This fixes the black screen on mobile.
        playing={false} 
